...
<%
       if (error == false) {                                           //did we open the index?
                ...
                queryForSites = "sites".equals(request.getParameter("queryType"));
                try {
...
%>
				Results of <%= queryForSites ? "site" : "image" %> query for <%= "\"" + queryString + "\"" %>:
                <table>
                <tr>
                        <td><%= queryForSites ? "<b>Site</b>" : "<b>Image</b>" %></td>
                        <td><%= queryForSites ? "<b>Summary</b>" : "<b>Title</b>" %></td>
                </tr>
<%
