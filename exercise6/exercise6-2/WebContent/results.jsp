<!--
 ...
 -->
<%@ page import = "  javax.servlet.*, javax.servlet.http.*, java.io.*, org.apache.lucene.analysis.*, org.apache.lucene.analysis.standard.StandardAnalyzer, org.apache.lucene.document.*, org.apache.lucene.index.*, org.apache.lucene.store.*, org.apache.lucene.search.IndexSearcher, org.apache.lucene.search.Query, org.apache.lucene.search.TopDocs, org.apache.lucene.queryParser.*, org.apache.lucene.demo.*, org.apache.lucene.demo.html.Entities, java.net.URLEncoder, org.apache.lucene.util.Version" %>
...
<%
       if (error == false) {                                           //did we open the index?
                ...
                searchForSites = "sites".equals(request.getParameter("sitesOrImages"));
...
%>
				<p>
					Results of query for <%= "\"" + queryString + "\"" %>:
				</p>
                <table>
                <tr>
                        <td><%= searchForSites ? "<b>Html site</b>" : "<b>Image</b>" %></td>
                        <td><%= searchForSites ? "<b>Summary</b>" : "<b>Title</b>" %></td>
                </tr>
<%
